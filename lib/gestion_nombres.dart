          ...
          ElevatedButton(
            onPressed: () async {
              if (_controller.text.isNotEmpty) {
                try {
                  if (idDocumento == null) {
                    // GUARDAR NUEVO EN FIREBASE (Estructura estándar)
                    ...
                    // ACTUALIZAR EXISTENTE EN FIREBASE
            ...
            Expanded(
              child: StreamBuilder<QuerySnapshot>(
                ...
                builder: (context, snapshot) {
                  ...
                  // LECTURA SEGURA: Mapea la lista global tolerando inconsistencias de nombres
